...
public class Counter {
    ...
    public final void printPerformance(LoggerUtil logger, String target) {
        ...
        if (value == 0) {
            ...
            if (value % freqeuncy == 0) {
                ...
                if (interval != 0) {
                    logger.log(LoggerUtil.FATAL, target, "Process Speed: " + (value * 1000.0 / interval)
                            + " times per seconds");
                } else {
                    logger.log(LoggerUtil.FATAL, target,
                                    "Process Speed is too high. JVM supported minimum time slot is milliseconds. please increase the Counter.frequence");
                }
                start = end;
                value = 0L;
            }
