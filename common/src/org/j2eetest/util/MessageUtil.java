...
import org.j2eetest.bean.CommonConstants;
import org.j2eetest.bean.FileType;
import org.j2eetest.bean.RelativePath;
import org.j2eetest.exception.BaseException;


public class MessageUtil {

    static final LoggerUtil logger = LoggerUtil.getLogger(MessageUtil.class);
    ...
    public final static void addMessages(String messageFile, FileType fileType,
            RelativePath relativePath) throws BaseException {
        ...
        try {
            ...
            switch (fileType) {
                ...
                default: {
                    throw new BaseException("Unvalid the file type. pls refer to "
