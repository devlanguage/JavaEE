...
public class StringEncryptHelper {
	...
	/**
	 * String constructor
	 * make this constructor private temporarily
	 * @param strKey
	 * @throws Exception
	 */
	private StringEncryptHelper(String strKey) {
		...
		try {		
			...
			LoggerUtil.getLogger(StringEncryptHelper.class).log(LoggerUtil.ERROR, "StringEncryptHelper", exp.getMessage(), exp);
		}
	}
	...
	public String encrypt(String input) {
		try {
			...
			LoggerUtil.getLogger(StringEncryptHelper.class).log(LoggerUtil.ERROR, "encrypt", exp.getMessage(), exp);
			return input;
		}
	}
	...
	public String decrypt(String input) {
		try {
			...
			LoggerUtil.getLogger(StringEncryptHelper.class).log(LoggerUtil.ERROR, "decrypt", exp.getMessage(), exp);
			return input;
		}
	}
	 ...
	 * @param arrBTmp , byte array of string
	 * @return
	 * @throws Exception
	 */
