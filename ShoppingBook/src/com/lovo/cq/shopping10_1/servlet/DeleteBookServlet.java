...
//		鑾峰緱鐢ㄦ埛 id闆嗗悎
		String orders_str = request.getParameter("bookIds");
		//鑾峰緱褰撳墠椤靛彿
		...
		if(model.deleteBook(ids)) {
			request.getRequestDispatcher("getBookPagerServlet?pager.offset="+pageOffset+"&pageSize="+pageSize).forward(request, response);
		}
	}
