									...
									<form method="post" name="deleteForm">
										<c:forEach var="inform" items="${informList}">
											<tr>
												...
												<td bgcolor="#FFFFFF" class="STYLE2">
													<textarea rows="4" cols="40">${inform.informContent }</textarea>
												</td>
												<td bgcolor="#FFFFFF" class="STYLE2">
													<input type="checkbox" name="delete"
														value="${inform.informId }">
												</td>
											</tr>
										</c:forEach>
									</form>
						...
						<tr>
							...
							<td background="Admin/images/tab_21.gif">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td>
											<pg:pager items="${informPager.totalNum }"
												maxPageItems="${informPager.pageSize}"
												export="currentPageNo = pageNumber"
												url="getInformPagerServlet">
												...
												<pg:pages>
													<c:choose>
														<c:when
															test="${informPager.pagecurrentPageNo eq pageNumber}">
										...
										<td colspan="1" align="right">
											<input type="button" value="删除"
												onclick="removeInform(${informPager.pageOffset},${informPager.pageSize})">
										</td>
										<td width="14">
