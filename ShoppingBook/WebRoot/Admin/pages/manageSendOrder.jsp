...
<html>
	...
	-->
		...
		<link rel="stylesheet" type="text/css"
			href="Admin/css/td_fontSize.css">
		...
		<table width="100%" border="0" align="center" cellpadding="0"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="15" height="30">
								<img src="Admin/images/tab_03.gif" width="15" height="30" />
							</td>
							<td width="1101" background="Admin/images/tab_05.gif">
								&nbsp;
							</td>
							...
							<td width="14">
								<img src="Admin/images/tab_07.gif" width="14" height="30" />
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="9" background="Admin/images/tab_12.gif">
								&nbsp;
							</td>
							<td bgcolor="#f3ffe3">
								...
								<table width="99%" border="0" align="center" cellpadding="0"
									...
									<tr>
										<th background="Admin/images/tab_14.gif">
											订单ID
										</th>
										<th background="Admin/images/tab_14.gif">
											用户名
										...
										<td background="Admin/images/tab_14.gif">
									...
									<form method="post" name="sendForm">
										<c:forEach var="order" items="${ orderList}">
											<tr>
												...
												<td bgcolor="#FFFFFF" class="STYLE2" width="100px">
													${order.orderDate }
												</td>
												<td bgcolor="#FFFFFF" class="STYLE2">
													${order.flag }
												...
												<td bgcolor="#FFFFFF" class="STYLE2">
													<a href="getOneOrderServlet?orderId=${order.orderId}">详情</a>
												</td>
											</tr>
										</c:forEach>
									</form>
							...
							<td width="9" background="Admin/images/tab_16.gif">
								&nbsp;
							</td>
						</tr>
					</table>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="15" height="29">
								<img src="Admin/images/tab_20.gif" width="15" height="29" />
							</td>
							<td background="Admin/images/tab_21.gif">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td>
											<pg:pager items="${orderPager.totalNum }"
												maxPageItems="${orderPager.pageSize}"
												export="currentPageNo = pageNumber"
												url="getOrderSendPagerServlet">
												...
												<pg:pages>
													<c:choose>
														<c:when
															test="${orderPager.pagecurrentPageNo eq pageNumber}">
										...
										<td colspan="1" align="right">
											<input type="button" value="冻结"
												onclick="freezeOrder(${orderPager.pageOffset},${orderPager.pageSize})">
										</td>
										<td colspan="1" align="center">
											<input type="button" value="删除"
												onclick="removeOrder(${orderPager.pageOffset},${orderPager.pageSize})">
										</td>
										<td width="14">
											<img src="Admin/images/tab_22.gif" width="14" height="29" />
										</td>
									</tr>
								</table>
							</td>
