...
<table width="800" border="1" cellspacing="1" cellpadding="1">
  <tr>
    <td height="35" colspan="2" bgcolor="#999999">鐢ㄦ埛鍚嶏細${user.name}</td>
  </tr>
  <tr>
    <td width="112" height="35" bgcolor="#CCCCCC">绉诲姩鐢佃瘽锛�</td>
    <td width="675" height="35" bgcolor="#CCCCCC"><input type="text" name="mphone" size="20" /></td>
  </tr>
  <tr>
    <td height="35" bgcolor="#CCCCCC">鍥哄畾鐢佃瘽锛�</td>
    <td height="35" bgcolor="#CCCCCC"><input type="text" name="phone" size="20" /></td>
  </tr>
  <tr>
    <td height="35" bgcolor="#CCCCCC">鏀惰揣鍦板潃锛�</td>
    <td height="35" bgcolor="#CCCCCC"><input type="text" name="address" size="20" /></td>
  </tr>
  <tr>
    <td height="35" bgcolor="#CCCCCC">閭斂缂栫爜锛�</td>
...
<table width="600" border="1" cellspacing="1" cellpadding="1">
  <tr>
    <td width="120" height="30" bgcolor="#CC9966">涔︾睄缂栧彿</td>
    <td width="120" height="30" bgcolor="#CC9966">涔︾睄鍚�</td>
    <td width="120" height="30" bgcolor="#CC9966">鍗曚环</td>
    <td width="110" height="30" bgcolor="#CC9966">鏁伴噺</td>
    <td width="130" height="30" bgcolor="#CC9966">浠锋牸</td>
  </tr>
  <%
...
<table width="600" height="30" border="1" cellpadding="1" cellspacing="1">
  <tr>
    <td width="300" bgcolor="#FF9966"><div align="center">杩斿洖璐墿杞�</div></td>
    <td width="300" bgcolor="#FF9966"><input type="submit" value="鎻愪氦璁㈠崟"/></td>
  </tr>
</table>
</form>
  </body>
