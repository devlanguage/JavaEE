...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements ws.foshanshop.com.HelloWorldService {
    ...
    private java.lang.String HelloWorldPort_address = "http://localhost:8080/Services/HelloWorldService";
    ...
    public ws.foshanshop.com.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.foshanshop.com.HelloWorldBindingStub _stub = new ws.foshanshop.com.HelloWorldBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.foshanshop.com.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.foshanshop.com.HelloWorldBindingStub _stub = new ws.foshanshop.com.HelloWorldBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://com.foshanshop.ws", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://com.foshanshop.ws", "HelloWorldPort"));
        }
