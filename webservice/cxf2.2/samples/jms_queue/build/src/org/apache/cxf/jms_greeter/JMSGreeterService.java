...
public class JMSGreeterService extends Service {
    ...
    static {
        ...
        try {
            ...
            System.err.println("Can not initialize the default wsdl from file:/D:/Java/eclipse_projects/webservice/source/cxf2.2/samples/jms_queue/wsdl/jms_greeter.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
