...
@WebServiceClient(name = "JMSGreeterService", targetNamespace = "http://cxf.apache.org/jms_greeter", wsdlLocation = "file:/D:/Java/eclipse_projects/webservice/source/cxf2.2/samples/jms_pubsub/wsdl/jms_greeter.wsdl")
public class JMSGreeterService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Java/eclipse_projects/webservice/source/cxf2.2/samples/jms_pubsub/wsdl/jms_greeter.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/D:/Java/eclipse_projects/webservice/source/cxf2.2/samples/jms_pubsub/wsdl/jms_greeter.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
