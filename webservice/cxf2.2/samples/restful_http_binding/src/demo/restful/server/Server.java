...
public final class Server {
    ...
    public static void main(String[] args) throws Exception {
        ...
        createSoapService(customerService);

        createRestService(customerService);

        createJsonRestService(customerService);
    ...
    private static void createJsonRestService(Object customerService) {
        // Build up the server factory bean
        JaxWsServerFactoryBean sf = new JaxWsServerFactoryBean();
        sf.setServiceClass(CustomerService.class);
        // Use the HTTP Binding which understands the Java Rest Annotations
    ...
    private static void createSoapService(Object customerService) {
        JaxWsServerFactoryBean sf = new JaxWsServerFactoryBean();
        sf.setServiceClass(CustomerService.class);
