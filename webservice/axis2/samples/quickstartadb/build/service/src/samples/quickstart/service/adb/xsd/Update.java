 ...
 *  Update bean class
 */
public class Update implements org.apache.axis2.databinding.ADBBean {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName(
                "http://quickstart.samples/xsd", "symbol"));
        ...
        elementList.add(new javax.xml.namespace.QName(
                "http://quickstart.samples/xsd", "price"));
    ...
    public static class Factory {
        ...
        public static Update parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"update".equals(type)) {
                            ...
                            return (Update) samples.quickstart.service.adb.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://quickstart.samples/xsd", "price").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
