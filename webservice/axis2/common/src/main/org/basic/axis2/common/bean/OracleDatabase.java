...
public class OracleDatabase implements Database {
    ...
    static {
        ...
        try {
            properties.loadFromXML(OracleDatabase.class
                    .getResourceAsStream(CommonConstants.DB_ORACLE_CONFIG_FILE));
            host = properties.getProperty(CommonConstants.DB_ORACLE_HOST);
            port = properties.getProperty(CommonConstants.DB_ORACLE_PORT);
            sid = properties.getProperty(CommonConstants.DB_ORACLE_SID);
            user = properties.getProperty(CommonConstants.DB_ORACLE_USER);
            password = properties.getProperty(CommonConstants.DB_ORACLE_PASSWORD);
            url = properties.getProperty(CommonConstants.DB_ORACLE_URL);
