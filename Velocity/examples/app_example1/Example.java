 ...
 * @version $Id: Example.java,v 1.1 2015/06/30 06:43:10 ygong Exp $
 */

public class Example {

    public final static String current_path = "source/ui/velocity/examples/xmlapp_example/";
    ...
    public Example(String templateFile) {
        ...
        try {
            ...
            Velocity.init(current_path + "velocity.properties");
    ...
    public static void main(String[] args) {
        ...
        Example t = new Example(current_path + "example.vm");
    }
}
