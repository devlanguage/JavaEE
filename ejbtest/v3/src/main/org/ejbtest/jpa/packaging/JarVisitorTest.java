//$Id: JarVisitorTest.java,v 1.1 2015/06/30 06:43:15 ygong Exp $
package org.ejbtest.jpa.packaging;
...
public class JarVisitorTest extends TestCase {
	...
	public void testInputStreamZippedJar() throws Exception {
		...
		entry = new JarVisitor.Entry( org.ejbtest.jpa.pack.defaultpar.Version.class.getName(), null );
		assertTrue( entries.contains( entry ) );
