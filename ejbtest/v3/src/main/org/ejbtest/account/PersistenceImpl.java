...
public class PersistenceImpl extends javax.persistence.Persistence {

    // typo intended because it leaked into the JPAspec. Do not use this constant.
     ...
     *            The name of the persistence unit
     * @param properties
     *            Additional properties to use when creating the factory. The values of these properties override any
